...
def parse_args():
    ...
    parser.add_argument("--prompt_template", type=str, default=None,
                        help="Prompt template name (e.g., baseline_qwen_instruct)")
...
def main():
    args = parse_args()
    print(f"Evaluating baseline: model={args.model_name}, problems={args.problems_path}, template={args.prompt_template}")
